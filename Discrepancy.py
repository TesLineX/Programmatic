...
def link_1(start_date, end_date):
  text = f'https://daopush-api.info/api/statistic/pops-web?api-key={dsp_token}&groupBy=days&sourceId={dsp_part_id}&startDate={start_date}&endDate={end_date}&timeZone=UTC'
  return text
